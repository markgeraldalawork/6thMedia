...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-D4IRYKXE.js").then(function(n4) {
...
function _upload(client, httpRequest, assetType, body, opts = {}) {
  ...
  const config2 = client.config(), options = optionsFromFile(opts, body), { tag, label, title, description, creditLine, filename, source } = options, isMediaLibrary = ((_a2 = config2.resource) == null ? void 0 : _a2.type) === "media-library", query = isMediaLibrary ? {
...
var eventSourcePolyfill = defer(() => import("./browser-44DM2QMR.js")).pipe(
...
var ObservableMediaLibraryVideoClient = class {
  ...
  getPlaybackInfo(assetIdentifier, options = {}) {
    var _a2;
    const config2 = __privateGet(this, _client12).config(), configMediaLibraryId = (_a2 = config2.resource || config2["~experimental_resource"]) == null ? void 0 : _a2.id, { instanceId, libraryId } = parseAssetInstanceId(assetIdentifier), effectiveLibraryId = libraryId || configMediaLibraryId;
